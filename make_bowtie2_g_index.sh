...
sed 'y/Uu/Tt/' db/smr_v4.3_sensitive_db.fasta > db/smr_v4.3_sensitive_db_dna.fasta
bowtie2-build --threads 20 db/smr_v4.3_sensitive_db_dna.fasta ref_bowtie2/default_plant
