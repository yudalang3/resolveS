...
# 定义变量
OUTPUT_DIR="db"
IMAGE_NAME="${OUTPUT_DIR}/resolveS_apptainer_v0.0.6.sif"
...
%help
    这是 resolveS 的 Apptainer 容器镜像 v0.0.6。

    使用方法:
        apptainer run resolveS_apptainer_v0.0.6.sif
        apptainer exec resolveS_apptainer_v0.0.6.sif resolveS

    resolveS 是一个快速检测 RNA-Seq 链特异性的工具。
EOF

echo "========================================"
echo "开始构建 Apptainer 镜像 v0.0.6..."
echo "========================================"
